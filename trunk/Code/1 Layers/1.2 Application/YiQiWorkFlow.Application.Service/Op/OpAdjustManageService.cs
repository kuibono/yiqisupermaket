...
{
    public class OpAdjustManageService:IOpAdjustManageService
    {

        public IRepositoryGUID<OpAdjustManage> EntityRepository { get; set; }

        [Transaction]
        public string Create(OpAdjustManage entity)
        {
        ...
        [Transaction]
        public OpAdjustManage GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<OpAdjustManage> GetAll()
        {
        ...
        [Transaction]
        public void Update(OpAdjustManage entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(OpAdjustManage entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<OpAdjustManage> entitys)
        {
        ...
        [Transaction]
        public SearchResult<OpAdjustManage> Search(SearchDtoBase<OpAdjustManage> c)
        {
		...
		[Transaction]
        public IList<OpAdjustManage> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
