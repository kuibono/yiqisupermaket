...
{
    public class BsBranchAllotDetailService:IBsBranchAllotDetailService
    {

        public IRepositoryGUID<BsBranchAllotDetail> EntityRepository { get; set; }

        [Transaction]
        public string Create(BsBranchAllotDetail entity)
        {
        ...
        [Transaction]
        public BsBranchAllotDetail GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BsBranchAllotDetail> GetAll()
        {
        ...
        [Transaction]
        public void Update(BsBranchAllotDetail entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BsBranchAllotDetail entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BsBranchAllotDetail> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BsBranchAllotDetail> Search(SearchDtoBase<BsBranchAllotDetail> c)
        {
		...
		[Transaction]
        public IList<BsBranchAllotDetail> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
