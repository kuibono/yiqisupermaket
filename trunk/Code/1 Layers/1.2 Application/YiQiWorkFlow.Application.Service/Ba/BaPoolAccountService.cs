...
{
    public class BaPoolAccountService:IBaPoolAccountService
    {

        public IRepositoryGUID<BaPoolAccount> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaPoolAccount entity)
        {
        ...
        [Transaction]
        public BaPoolAccount GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaPoolAccount> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaPoolAccount entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaPoolAccount entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaPoolAccount> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaPoolAccount> Search(SearchDtoBase<BaPoolAccount> c)
        {
		...
		[Transaction]
        public IList<BaPoolAccount> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
