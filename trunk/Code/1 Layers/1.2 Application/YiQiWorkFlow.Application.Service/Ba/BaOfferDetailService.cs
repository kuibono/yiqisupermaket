...
{
    public class BaOfferDetailService:IBaOfferDetailService
    {

        public IRepositoryGUID<BaOfferDetail> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaOfferDetail entity)
        {
        ...
        [Transaction]
        public BaOfferDetail GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaOfferDetail> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaOfferDetail entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaOfferDetail entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaOfferDetail> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaOfferDetail> Search(SearchDtoBase<BaOfferDetail> c)
        {
		...
		[Transaction]
        public IList<BaOfferDetail> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
