...
{
    public class BaBranchOfferDetailService:IBaBranchOfferDetailService
    {

        public IRepositoryGUID<BaBranchOfferDetail> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaBranchOfferDetail entity)
        {
        ...
        [Transaction]
        public BaBranchOfferDetail GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaBranchOfferDetail> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaBranchOfferDetail entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaBranchOfferDetail entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaBranchOfferDetail> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaBranchOfferDetail> Search(SearchDtoBase<BaBranchOfferDetail> c)
        {
		...
		[Transaction]
        public IList<BaBranchOfferDetail> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
