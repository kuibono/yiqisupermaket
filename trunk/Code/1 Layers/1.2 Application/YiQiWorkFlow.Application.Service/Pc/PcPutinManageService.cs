...
namespace YiQiWorkFlow.Application.Service.Pc
{
    public class PcPutinManageService:IPcPutinManageService
    {
        ...
        public IRepositoryGUID<PcPutinManage> EntityRepository { get; set; }

        [Transaction]
        public string Create(PcPutinManage entity)
        {
        ...
        [Transaction]
        public PcPutinManage GetById(string id)
        {
            ...
            if (c.entity != null)
            {
				...
				if (string.IsNullOrEmpty(c.entity.Id) == false)
                {
                    q = q.Where(p => p.Id.Contains(c.entity.Id));
					 ...
					 if (c.entity.PiFlowNumber > 0)
					{
						q = q.Where(p => p.PiFlowNumber == c.entity.PiFlowNumber);
					}
