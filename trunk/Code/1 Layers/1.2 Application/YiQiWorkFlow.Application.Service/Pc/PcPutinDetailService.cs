...
{
    public class PcPutinDetailService:IPcPutinDetailService
    {

        public IRepositoryGUID<PcPutinDetail> EntityRepository { get; set; }

        [Transaction]
        public string Create(PcPutinDetail entity)
        {
        ...
        [Transaction]
        public PcPutinDetail GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<PcPutinDetail> GetAll()
        {
        ...
        [Transaction]
        public void Update(PcPutinDetail entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(PcPutinDetail entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<PcPutinDetail> entitys)
        {
        ...
        [Transaction]
        public SearchResult<PcPutinDetail> Search(SearchDtoBase<PcPutinDetail> c)
        {
		...
		[Transaction]
        public IList<PcPutinDetail> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
