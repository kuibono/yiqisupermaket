...
{
    public class AcDayClassJournalAccountService:IAcDayClassJournalAccountService
    {

        public IRepositoryGUID<AcDayClassJournalAccount> EntityRepository { get; set; }

        [Transaction]
        public string Create(AcDayClassJournalAccount entity)
        {
        ...
        [Transaction]
        public AcDayClassJournalAccount GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<AcDayClassJournalAccount> GetAll()
        {
        ...
        [Transaction]
        public void Update(AcDayClassJournalAccount entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(AcDayClassJournalAccount entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<AcDayClassJournalAccount> entitys)
        {
        ...
        [Transaction]
        public SearchResult<AcDayClassJournalAccount> Search(SearchDtoBase<AcDayClassJournalAccount> c)
        {
		...
		[Transaction]
        public IList<AcDayClassJournalAccount> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
