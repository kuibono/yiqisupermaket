...
namespace YiQiWorkFlow.Application.Service.Ac
{
    public class AcDayGoodsJournalAccountService:IAcDayGoodsJournalAccountService
    {
        ...
        public IRepository<AcDayGoodsJournalAccount> EntityRepository { get; set; }

        [Transaction]
        public int Create(AcDayGoodsJournalAccount entity)
        {
            return EntityRepository.Save(entity);
        }

        [Transaction]
        public AcDayGoodsJournalAccount GetById(int id)
        {
