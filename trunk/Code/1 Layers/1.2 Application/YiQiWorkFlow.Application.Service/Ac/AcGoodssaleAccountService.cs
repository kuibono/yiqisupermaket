...
{
    public class AcGoodssaleAccountService:IAcGoodssaleAccountService
    {

        public IRepositoryGUID<AcGoodssaleAccount> EntityRepository { get; set; }

        [Transaction]
        public string Create(AcGoodssaleAccount entity)
        {
        ...
        [Transaction]
        public AcGoodssaleAccount GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<AcGoodssaleAccount> GetAll()
        {
        ...
        [Transaction]
        public void Update(AcGoodssaleAccount entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(AcGoodssaleAccount entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<AcGoodssaleAccount> entitys)
        {
        ...
        [Transaction]
        public SearchResult<AcGoodssaleAccount> Search(SearchDtoBase<AcGoodssaleAccount> c)
        {
		...
		[Transaction]
        public IList<AcGoodssaleAccount> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
