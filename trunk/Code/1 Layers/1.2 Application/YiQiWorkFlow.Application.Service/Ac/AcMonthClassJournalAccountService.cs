...
{
    public class AcMonthClassJournalAccountService:IAcMonthClassJournalAccountService
    {

        public IRepositoryGUID<AcMonthClassJournalAccount> EntityRepository { get; set; }

        [Transaction]
        public string Create(AcMonthClassJournalAccount entity)
        {
        ...
        [Transaction]
        public AcMonthClassJournalAccount GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<AcMonthClassJournalAccount> GetAll()
        {
        ...
        [Transaction]
        public void Update(AcMonthClassJournalAccount entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(AcMonthClassJournalAccount entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<AcMonthClassJournalAccount> entitys)
        {
        ...
        [Transaction]
        public SearchResult<AcMonthClassJournalAccount> Search(SearchDtoBase<AcMonthClassJournalAccount> c)
        {
            ...
            if (c.entity != null)
            {
				...
				if (string.IsNullOrEmpty(c.entity.Id) == false)
                {
					...
					if (string.IsNullOrEmpty(c.entity.AcMonth) == false)
					{
						
						q = q.Where(p => p.AcMonth.Contains(c.entity.AcMonth));
					}
		...
		[Transaction]
        public IList<AcMonthClassJournalAccount> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
