...
{
    public class AcMonthGoodsJournalAccountService:IAcMonthGoodsJournalAccountService
    {

        public IRepositoryGUID<AcMonthGoodsJournalAccount> EntityRepository { get; set; }

        [Transaction]
        public string Create(AcMonthGoodsJournalAccount entity)
        {
        ...
        [Transaction]
        public AcMonthGoodsJournalAccount GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<AcMonthGoodsJournalAccount> GetAll()
        {
        ...
        [Transaction]
        public void Update(AcMonthGoodsJournalAccount entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(AcMonthGoodsJournalAccount entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<AcMonthGoodsJournalAccount> entitys)
        {
        ...
        [Transaction]
        public SearchResult<AcMonthGoodsJournalAccount> Search(SearchDtoBase<AcMonthGoodsJournalAccount> c)
        {
		...
		[Transaction]
        public IList<AcMonthGoodsJournalAccount> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
