...
{
    public class RtSheetPromotionGoodsService:IRtSheetPromotionGoodsService
    {

        public IRepositoryGUID<RtSheetPromotionGoods> EntityRepository { get; set; }

        [Transaction]
        public string Create(RtSheetPromotionGoods entity)
        {
        ...
        [Transaction]
        public RtSheetPromotionGoods GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<RtSheetPromotionGoods> GetAll()
        {
        ...
        [Transaction]
        public void Update(RtSheetPromotionGoods entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(RtSheetPromotionGoods entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<RtSheetPromotionGoods> entitys)
        {
        ...
        [Transaction]
        public SearchResult<RtSheetPromotionGoods> Search(SearchDtoBase<RtSheetPromotionGoods> c)
        {
		...
		[Transaction]
        public IList<RtSheetPromotionGoods> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
