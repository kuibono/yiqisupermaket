...
{
    public class RtClassPromotionService:IRtClassPromotionService
    {

        public IRepositoryGUID<RtClassPromotion> EntityRepository { get; set; }

        [Transaction]
        public string Create(RtClassPromotion entity)
        {
        ...
        [Transaction]
        public RtClassPromotion GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<RtClassPromotion> GetAll()
        {
        ...
        [Transaction]
        public void Update(RtClassPromotion entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(RtClassPromotion entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<RtClassPromotion> entitys)
        {
        ...
        [Transaction]
        public SearchResult<RtClassPromotion> Search(SearchDtoBase<RtClassPromotion> c)
        {
		...
		[Transaction]
        public IList<RtClassPromotion> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
