...
{
    public class RtPresentPromotionGoodsService:IRtPresentPromotionGoodsService
    {

        public IRepositoryGUID<RtPresentPromotionGoods> EntityRepository { get; set; }

        [Transaction]
        public string Create(RtPresentPromotionGoods entity)
        {
        ...
        [Transaction]
        public RtPresentPromotionGoods GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<RtPresentPromotionGoods> GetAll()
        {
        ...
        [Transaction]
        public void Update(RtPresentPromotionGoods entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(RtPresentPromotionGoods entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<RtPresentPromotionGoods> entitys)
        {
        ...
        [Transaction]
        public SearchResult<RtPresentPromotionGoods> Search(SearchDtoBase<RtPresentPromotionGoods> c)
        {
		...
		[Transaction]
        public IList<RtPresentPromotionGoods> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
