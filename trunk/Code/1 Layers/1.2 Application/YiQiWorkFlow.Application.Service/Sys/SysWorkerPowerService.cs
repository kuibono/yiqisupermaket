...
{
    public class SysWorkerPowerService:ISysWorkerPowerService
    {

        public IRepositoryGUID<SysWorkerPower> EntityRepository { get; set; }

        [Transaction]
        public string Create(SysWorkerPower entity)
        {
        ...
        [Transaction]
        public SysWorkerPower GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<SysWorkerPower> GetAll()
        {
        ...
        [Transaction]
        public void Update(SysWorkerPower entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(SysWorkerPower entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<SysWorkerPower> entitys)
        {
        ...
        [Transaction]
        public SearchResult<SysWorkerPower> Search(SearchDtoBase<SysWorkerPower> c)
        {
		...
		[Transaction]
        public IList<SysWorkerPower> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
