...
{
    public class PcPurchaseManageHistoryService : IPcPurchaseManageHistoryService
    {
        ...
        [Transaction]
        public string Create(PcPurchaseManageHistory entity)
        {
            return EntityRepository.Save(entity);

        }
        [Transaction]
        public void Save(PcPurchaseManageHistory entity)
        {
            bool add = false;
        ...
        [Transaction]
        public PcPurchaseManageHistory GetById(string id)
        {
        ...
        private void FillPurchaseInfo(PcPurchaseManageHistory entity)
        {
        ...
        [Transaction]
        private void FillDepartmentName(IList<PcPurchaseManageHistory> manages)
        {
        ...
        private void FillBranchName(IList<PcPurchaseManageHistory> manages)
        {
            var branchs = BranchRepository.LinqQuery.ToList();
            for (int i = 0; i < manages.Count; i++)
            {
        ...
        private void FillDepartmentName(PcPurchaseManageHistory manage)
        {
            var departments = DepartmentRepository.LinqQuery.ToList();
        ...
        {
            PcPurchaseManageHistory entity = EntityRepository.Get(id);
            if (entity == null)
                return;
        ...
        [Transaction]
        public IList<PcPurchaseManageHistory> GetAll()
        {
        ...
        [Transaction]
        public void Update(PcPurchaseManageHistory entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(PcPurchaseManageHistory entity)
        {
        ...
        [Transaction]
        public void Delete(IEnumerable<PcPurchaseManageHistory> entitys)
        {
        ...
        [Transaction]
        public SearchResult<PcPurchaseManageHistory> Search(string SupplierId,SearchDtoBase<PcPurchaseManageHistory> c)
        {
        ...
        public IList<PcPurchaseManageHistory> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
