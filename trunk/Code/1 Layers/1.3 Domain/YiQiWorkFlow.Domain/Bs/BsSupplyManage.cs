...
{
	///<summary>
	///表bs_supply_manage的实体类(分店商品订货配送单)
	///</summary>
	public class BsSupplyManage : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 分店编码
		/// </summary>
		...
		///实体复制
		public BsSupplyManage Clone()
        {
            return (BsSupplyManage)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BsSupplyManage Initial()
        {
            BsSupplyManage m = new BsSupplyManage();
