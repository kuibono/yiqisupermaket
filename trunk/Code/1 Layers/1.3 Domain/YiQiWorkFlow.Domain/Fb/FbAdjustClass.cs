...
{
	///<summary>
	///表fb_adjust_class的实体类(调商品所属类别)
	///</summary>
	public class FbAdjustClass : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 调整单号
		/// </summary>
		...
		///实体复制
		public FbAdjustClass Clone()
        {
            return (FbAdjustClass)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static FbAdjustClass Initial()
        {
