...
namespace YiQiWorkFlow.Domain.Basement
{
    ...
    public partial class op_allot_manage_flow
    {
        public decimal al_flow_number { get; set; }
        public string al_number { get; set; }
        public string al_type { get; set; }
        public string organ_out { get; set; }
        public string organ_name_out { get; set; }
        public string wh_code_out { get; set; }
        public string organ_in { get; set; }
        public string organ_name_in { get; set; }
