...
namespace YiQiWorkFlow.Domain.Ws
{
	...
	public class WsWholesaleManageFlow : EntityGUIDBase, IAggregateRootGUID
	{
		...
		/// 批发金额
		/// </summary>
		[Validate(ValidateType.IsDecimal ,Name="批发金额")]
		public virtual decimal WsMoney{get ; set; }
		...
		///实体复制
		public WsWholesaleManageFlow Clone()
        {
            return (WsWholesaleManageFlow)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
