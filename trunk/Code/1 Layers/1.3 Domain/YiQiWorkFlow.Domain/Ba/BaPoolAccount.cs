...
{
	///<summary>
	///表ba_pool_account的实体类(联营对帐单)
	///</summary>
	public class BaPoolAccount : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 对帐单号
		/// </summary>
		...
		///实体复制
		public BaPoolAccount Clone()
        {
            return (BaPoolAccount)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BaPoolAccount Initial()
        {
            BaPoolAccount m = new BaPoolAccount();
