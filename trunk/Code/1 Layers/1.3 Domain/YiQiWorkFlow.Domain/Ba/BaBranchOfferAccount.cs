...
{
	///<summary>
	///表ba_branch_offer_account的实体类(分店代销对帐)
	///</summary>
	public class BaBranchOfferAccount : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 对帐单号
		/// </summary>
		...
		///实体复制
		public BaBranchOfferAccount Clone()
        {
            return (BaBranchOfferAccount)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BaBranchOfferAccount Initial()
        {
            BaBranchOfferAccount m = new BaBranchOfferAccount();
