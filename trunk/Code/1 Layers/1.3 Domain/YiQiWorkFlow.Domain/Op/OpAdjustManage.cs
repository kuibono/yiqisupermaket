...
{
	///<summary>
	///表op_adjust_manage的实体类(商品调整单)
	///</summary>
	public class OpAdjustManage : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 调整单号
		/// </summary>
		...
		///实体复制
		public OpAdjustManage Clone()
        {
            return (OpAdjustManage)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static OpAdjustManage Initial()
        {
            OpAdjustManage m = new OpAdjustManage();
