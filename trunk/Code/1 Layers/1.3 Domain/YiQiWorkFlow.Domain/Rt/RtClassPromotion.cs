...
{
	///<summary>
	///表rt_class_promotion的实体类(类别促销)
	///</summary>
	public class RtClassPromotion : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 企业编码
		/// </summary>
		...
		///实体复制
		public RtClassPromotion Clone()
        {
            return (RtClassPromotion)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static RtClassPromotion Initial()
        {
            RtClassPromotion m = new RtClassPromotion();
