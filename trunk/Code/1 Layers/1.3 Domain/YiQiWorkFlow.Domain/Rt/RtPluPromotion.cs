...
{
	///<summary>
	///表rt_plu_promotion的实体类(单品促销)
	///</summary>
	public class RtPluPromotion : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 促销单号
		/// </summary>
		...
		///实体复制
		public RtPluPromotion Clone()
        {
            return (RtPluPromotion)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static RtPluPromotion Initial()
        {
            RtPluPromotion m = new RtPluPromotion();
