...
{
	///<summary>
	///表ms_grant_card_manage的实体类(卡发放)
	///</summary>
	public class MsGrantCardManage : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 发放单号
		/// </summary>
		[Validate(ValidateType.IsEmpty ,Name="发放单号")]
		...
		///实体复制
		public MsGrantCardManage Clone()
        {
            return (MsGrantCardManage)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
