...
{
	///<summary>
	///表ac_day_class_journal_account的实体类(类别进销存日帐)
	///</summary>
	public class AcDayClassJournalAccount : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 流水单号
		/// </summary>
		...
		///实体复制
		public AcDayClassJournalAccount Clone()
        {
            return (AcDayClassJournalAccount)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static AcDayClassJournalAccount Initial()
        {
            AcDayClassJournalAccount m = new AcDayClassJournalAccount();
