...
{
    ///<summary>
    ///表ac_branch_goodssale_account的实体类(分店商品销售帐表)
    ///</summary>
    public class AcBranchGoodssaleAccount : EntityGUIDBase, IAggregateRootGUID
    {
        /// <summary>
        /// 流水单号
        /// </summary>
        ...
        ///实体复制
        public AcBranchGoodssaleAccount Clone()
        {
            return (AcBranchGoodssaleAccount)this.MemberwiseClone();
        }
        /// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static AcBranchGoodssaleAccount Initial()
        {
            AcBranchGoodssaleAccount m = new AcBranchGoodssaleAccount();
