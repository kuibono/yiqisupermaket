...
{
	///<summary>
	///表ac_day_branchgoods_journal_account的实体类(分店商品进销存日帐)
	///</summary>
	public class AcDayBranchgoodsJournalAccount : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 流水单号
		/// </summary>
		...
		///实体复制
		public AcDayBranchgoodsJournalAccount Clone()
        {
            return (AcDayBranchgoodsJournalAccount)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static AcDayBranchgoodsJournalAccount Initial()
        {
            AcDayBranchgoodsJournalAccount m = new AcDayBranchgoodsJournalAccount();
