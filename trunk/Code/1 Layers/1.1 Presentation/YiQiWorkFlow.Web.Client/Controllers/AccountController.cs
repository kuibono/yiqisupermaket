            ...
            object[] r = {
                         ...
                         new { iconCls = "icon-vcard", text = "会员卡券", menus = new object[]{
                            new { iconCls = "icon-node", text = "主营业务",  menus = new object[]{
                                ...
                                new { id = "193", iconCls = "icon-add", pid = "m6", text = "卡制作管理", url = "/Ms/MsMadecardManageEdit" },
                                new { id = "194", iconCls = "icon-add", pid = "m6", text = "会员档案管理", url = "/Ms/MsMemberArchivesEdit" },
                                new { id = "195", iconCls = "icon-add", pid = "m6", text = "卡发放管理", url = "/Ms/MsGrantCardManageEdit" },
                                new { id = "196", iconCls = "icon-add", pid = "m6", text = "卡挂失管理", url = "/Ms/MsLossCardManageEdit" },
                                new { id = "197", iconCls = "icon-add", pid = "m6", text = "卡冻结管理", url = "/Ms/MsFreezeCardManageEdit" },
                                new { id = "198", iconCls = "icon-add", pid = "m6", text = "卡废除管理", url = "/Ms/MsCancelCardManageEdit" },
                                new { id = "199", iconCls = "icon-add", pid = "m6", text = "卡更新管理", url = "/Ms/MsUpdateCardManageEdit" },
