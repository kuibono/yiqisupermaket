...
namespace NSH.VSTO
{
    public class SqlHelper
    {
        ...
        /// </summary>
        /// <param name="connStr"></param>
        public SqlHelper(string connStr, int Times)
        {
            this.Conn = new SqlConnection(connStr);
        ...
        public void Add(SqlParameter[] CmdParameters)
        {
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, SqlDbType DbType, object Value)
        {
            Cmd.Parameters.Add(new SqlParameter(ParamName, DbType)).Value = Value == null ? "" : Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, SqlDbType DbType, object Value, bool NoNull)
        {
            Cmd.Parameters.Add(new SqlParameter(ParamName, DbType)).Value = Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, SqlDbType DbType, object Value, int Size)
        {
            Cmd.Parameters.Add(new SqlParameter(ParamName, DbType, Size)).Value = Value == null ? "" : Value;
        }
        /// <summary> 
        ...
        /// <param name="NoNull"></param> 
        /// <remarks></remarks> 
        public void Add(string ParamName, SqlDbType DbType, object Value, int Size, bool NoNull)
        {
            Cmd.Parameters.Add(new SqlParameter(ParamName, DbType, Size)).Value = Value;
        }
        /// <summary> 
        ...
        /// <remarks></remarks> 
        public void Add(string ParamName, SqlDbType DbType, object Value, int Precision, int Scale)
        {
            SqlParameter aa = new SqlParameter(ParamName, DbType);
        ...
        private void CreateCmd(CommandType CmdType, string CmdText, DbParameter[] CmdParameters, SqlTransaction Transaction)
        {
        ...
        {
            return this.ExecuteDataSet(CmdType, CmdText, null, (SqlTransaction)Transaction);
        }
        #endregion

        #region 对连接执行 Transact-SQL 语句并返回DataSet/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataSet
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回DataSet/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters, SqlTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataSet
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            this.CreateCmd(CmdType, CmdText, CmdParameters, (SqlTransaction)Transaction);
        ...
        {
            return this.ExecuteDataTable(CmdType, CmdText, null, (SqlTransaction)Transaction);
        }
        #endregion

        #region 对连接执行 Transact-SQL 语句并返回DataTable/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataTable
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回DataTable/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters, SqlTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回DataTable
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 对连接执行 Transact-SQL 语句并返回受影响的行数/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回受影响的行数
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteNonQuery(CmdType, CmdText, null, (SqlTransaction)Transaction);
        }
        #endregion

        #region 对连接执行 Transact-SQL 语句并返回受影响的行数/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters, SqlTransaction Transaction
        /// <summary>
        /// 对连接执行 Transact-SQL 语句并返回受影响的行数
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteReader(CmdType, CmdText, null, (SqlTransaction)Transaction, ConnOwnership);
        }
        #endregion

        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters, ConnClose ConnOwnership
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters, SqlTransaction Transaction, ConnClose ConnOwnership
        /// <summary>
        /// 将CommandText发送到Connection，并使用CommandBehavior值之一生成一个SqlDataReader
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        {
            return this.ExecuteScalar(CmdType, CmdText, null, (SqlTransaction)Transaction);
        }
        #endregion

        #region 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters
        /// <summary>
        /// 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        #region 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行/参数：CommandType CmdType, string CmdText, SqlConnection[] CmdParameters, SqlTransaction Transaction
        /// <summary>
        /// 执行查询，并返回查询所返回的结果集中第一行的第一列。忽略其他列或行。
        /// </summary>
        /// <param name="CmdType">指定如何解释命令字符串</param>
        ...
        public DataTable PageListViewSort(string Tables, string PrimaryKey, string Sort, int CurrentPage, int PageSize, string Fields, string Filter, string group)
        {
            ...
            int strStartRow = (CurrentPage - 1) * PageSize + 1;
