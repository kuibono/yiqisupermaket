...
{
    public class FbAdjustSalepriceService:IFbAdjustSalepriceService
    {
        ...
        [Transaction]
        public IList<FbAdjustSaleprice> GetAll()
        {
        ...
        [Transaction]
        public void Update(FbAdjustSaleprice entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(FbAdjustSaleprice entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<FbAdjustSaleprice> entitys)
        {
        ...
        [Transaction]
        public SearchResult<FbAdjustSaleprice> Search(SearchDtoBase<FbAdjustSaleprice> c)
        {
		...
		[Transaction]
        public IList<FbAdjustSaleprice> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
