...
{
    public class BsSupplyPresentPromotionService:IBsSupplyPresentPromotionService
    {

        public IRepositoryGUID<BsSupplyPresentPromotion> EntityRepository { get; set; }

        [Transaction]
        public string Create(BsSupplyPresentPromotion entity)
        {
        ...
        [Transaction]
        public BsSupplyPresentPromotion GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BsSupplyPresentPromotion> GetAll()
        {
        ...
        [Transaction]
        public void Update(BsSupplyPresentPromotion entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BsSupplyPresentPromotion entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BsSupplyPresentPromotion> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BsSupplyPresentPromotion> Search(SearchDtoBase<BsSupplyPresentPromotion> c)
        {
		...
		[Transaction]
        public IList<BsSupplyPresentPromotion> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
