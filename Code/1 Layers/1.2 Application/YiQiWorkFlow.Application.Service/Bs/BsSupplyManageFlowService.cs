...
namespace YiQiWorkFlow.Application.Service.Bs
{
    public class BsSupplyManageFlowService:IBsSupplyManageFlowService
    {
        ...
        public IRepositoryGUID<BsSupplyManageFlow> EntityRepository { get; set; }

        [Transaction]
        public string Create(BsSupplyManageFlow entity)
        {
        ...
        [Transaction]
        public BsSupplyManageFlow GetById(string id)
        {
            ...
            if (c.entity != null)
            {
				...
				if (string.IsNullOrEmpty(c.entity.Id) == false)
                {
                    q = q.Where(p => p.Id.Contains(c.entity.Id));
					 ...
					 if (c.entity.SpFlowNumber > 0)
					{
						q = q.Where(p => p.SpFlowNumber == c.entity.SpFlowNumber);
					}
