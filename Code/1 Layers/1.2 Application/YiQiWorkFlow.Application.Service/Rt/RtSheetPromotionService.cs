...
{
    public class RtSheetPromotionService:IRtSheetPromotionService
    {

        public IRepositoryGUID<RtSheetPromotion> EntityRepository { get; set; }

        [Transaction]
        public string Create(RtSheetPromotion entity)
        {
        ...
        [Transaction]
        public RtSheetPromotion GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<RtSheetPromotion> GetAll()
        {
        ...
        [Transaction]
        public void Update(RtSheetPromotion entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(RtSheetPromotion entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<RtSheetPromotion> entitys)
        {
        ...
        [Transaction]
        public SearchResult<RtSheetPromotion> Search(SearchDtoBase<RtSheetPromotion> c)
        {
		...
		[Transaction]
        public IList<RtSheetPromotion> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
