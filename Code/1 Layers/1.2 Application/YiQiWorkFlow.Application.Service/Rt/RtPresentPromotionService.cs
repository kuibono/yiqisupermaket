...
{
    public class RtPresentPromotionService:IRtPresentPromotionService
    {

        public IRepositoryGUID<RtPresentPromotion> EntityRepository { get; set; }

        [Transaction]
        public string Create(RtPresentPromotion entity)
        {
        ...
        [Transaction]
        public RtPresentPromotion GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<RtPresentPromotion> GetAll()
        {
        ...
        [Transaction]
        public void Update(RtPresentPromotion entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(RtPresentPromotion entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<RtPresentPromotion> entitys)
        {
        ...
        [Transaction]
        public SearchResult<RtPresentPromotion> Search(SearchDtoBase<RtPresentPromotion> c)
        {
		...
		[Transaction]
        public IList<RtPresentPromotion> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
