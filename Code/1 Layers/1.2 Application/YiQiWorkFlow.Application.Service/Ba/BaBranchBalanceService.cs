...
{
    public class BaBranchBalanceService:IBaBranchBalanceService
    {

        public IRepositoryGUID<BaBranchBalance> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaBranchBalance entity)
        {
        ...
        [Transaction]
        public BaBranchBalance GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaBranchBalance> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaBranchBalance entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaBranchBalance entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaBranchBalance> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaBranchBalance> Search(SearchDtoBase<BaBranchBalance> c)
        {
		...
		[Transaction]
        public IList<BaBranchBalance> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
