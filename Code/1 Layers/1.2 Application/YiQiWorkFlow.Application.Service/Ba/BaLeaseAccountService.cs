...
{
    public class BaLeaseAccountService:IBaLeaseAccountService
    {

        public IRepositoryGUID<BaLeaseAccount> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaLeaseAccount entity)
        {
        ...
        [Transaction]
        public BaLeaseAccount GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaLeaseAccount> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaLeaseAccount entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaLeaseAccount entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaLeaseAccount> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaLeaseAccount> Search(SearchDtoBase<BaLeaseAccount> c)
        {
		...
		[Transaction]
        public IList<BaLeaseAccount> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
