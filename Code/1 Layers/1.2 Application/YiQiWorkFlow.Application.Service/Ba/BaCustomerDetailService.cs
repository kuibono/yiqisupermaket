...
{
    public class BaCustomerDetailService:IBaCustomerDetailService
    {

        public IRepositoryGUID<BaCustomerDetail> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaCustomerDetail entity)
        {
        ...
        [Transaction]
        public BaCustomerDetail GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaCustomerDetail> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaCustomerDetail entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaCustomerDetail entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaCustomerDetail> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaCustomerDetail> Search(SearchDtoBase<BaCustomerDetail> c)
        {
		...
		[Transaction]
        public IList<BaCustomerDetail> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
