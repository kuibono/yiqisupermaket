...
{
    public class BaSupplierBalanceService:IBaSupplierBalanceService
    {

        public IRepositoryGUID<BaSupplierBalance> EntityRepository { get; set; }

        [Transaction]
        public string Create(BaSupplierBalance entity)
        {
        ...
        [Transaction]
        public BaSupplierBalance GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<BaSupplierBalance> GetAll()
        {
        ...
        [Transaction]
        public void Update(BaSupplierBalance entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(BaSupplierBalance entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<BaSupplierBalance> entitys)
        {
        ...
        [Transaction]
        public SearchResult<BaSupplierBalance> Search(SearchDtoBase<BaSupplierBalance> c)
        {
		...
		[Transaction]
        public IList<BaSupplierBalance> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
