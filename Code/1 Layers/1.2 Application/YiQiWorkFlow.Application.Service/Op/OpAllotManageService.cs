...
{
    public class OpAllotManageService:IOpAllotManageService
    {

        public IRepositoryGUID<OpAllotManage> EntityRepository { get; set; }

        [Transaction]
        public string Create(OpAllotManage entity)
        {
        ...
        [Transaction]
        public OpAllotManage GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<OpAllotManage> GetAll()
        {
        ...
        [Transaction]
        public void Update(OpAllotManage entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(OpAllotManage entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<OpAllotManage> entitys)
        {
        ...
        [Transaction]
        public SearchResult<OpAllotManage> Search(SearchDtoBase<OpAllotManage> c)
        {
		...
		[Transaction]
        public IList<OpAllotManage> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
