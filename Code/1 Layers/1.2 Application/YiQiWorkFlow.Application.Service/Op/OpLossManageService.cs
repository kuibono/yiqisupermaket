...
{
    public class OpLossManageService:IOpLossManageService
    {

        public IRepositoryGUID<OpLossManage> EntityRepository { get; set; }

        [Transaction]
        public string Create(OpLossManage entity)
        {
        ...
        [Transaction]
        public OpLossManage GetById(string id)
        {
            return EntityRepository.Get(id);
        }

        [Transaction]
        public IList<OpLossManage> GetAll()
        {
        ...
        [Transaction]
        public void Update(OpLossManage entity)
        {
            EntityRepository.Update(entity);
        }

        [Transaction]
        public void Delete(OpLossManage entity)
        {
            EntityRepository.Delete(entity);
        }

        [Transaction]
        public void Delete(IEnumerable<OpLossManage> entitys)
        {
        ...
        [Transaction]
        public SearchResult<OpLossManage> Search(SearchDtoBase<OpLossManage> c)
        {
		...
		[Transaction]
        public IList<OpLossManage> Search(string key, int pageSize = 20, int pageIndex = 1)
        {
            var q = EntityRepository.LinqQuery;
