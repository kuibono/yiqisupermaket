...
namespace YiQiWorkFlow.Application.Service.Ac
{
    public class AcDayBranchgoodsJournalAccountService:IAcDayBranchgoodsJournalAccountService
    {
        ...
        public IRepository<AcDayBranchgoodsJournalAccount> EntityRepository { get; set; }

        [Transaction]
        public int Create(AcDayBranchgoodsJournalAccount entity)
        {
            return EntityRepository.Save(entity);
        }

        [Transaction]
        public AcDayBranchgoodsJournalAccount GetById(int id)
        {
