...
namespace YiQiWorkFlow.Application.Service.Ac
{
    public class AcMonthGoodsJournalAccountService:IAcMonthGoodsJournalAccountService
    {
        ...
        public IRepository<AcMonthGoodsJournalAccount> EntityRepository { get; set; }

        [Transaction]
        public int Create(AcMonthGoodsJournalAccount entity)
        {
            return EntityRepository.Save(entity);
        }

        [Transaction]
        public AcMonthGoodsJournalAccount GetById(int id)
        {
