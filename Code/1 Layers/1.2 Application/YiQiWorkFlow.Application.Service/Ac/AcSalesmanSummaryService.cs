...
namespace YiQiWorkFlow.Application.Service.Ac
{
    public class AcSalesmanSummaryService:IAcSalesmanSummaryService
    {
        ...
        public IRepositoryGUID<AcSalesmanSummary> EntityRepository { get; set; }

        [Transaction]
        public string Create(AcSalesmanSummary entity)
        {
        ...
        [Transaction]
        public AcSalesmanSummary GetById(string id)
        {
