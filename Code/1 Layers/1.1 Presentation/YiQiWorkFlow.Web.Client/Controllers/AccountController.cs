...
namespace YiQiWorkFlow.Web.Client.Controllers
{
    public class AccountController : Controller
    {
        ...
        public JsonResult GetModelesTree()
        {
            ...
            m1.Add(new { id = "103", iconCls = "icon-add", pid = "m1", text = "商品供货商调整", url = "/Fb/FbAdjustSupplierList" });
            m1.Add(new { id = "104", iconCls = "icon-add", pid = "m1", text = "商品扣率调整", url = "/Fb/FbAdjustPoolrateList" });
            ...
            m2.Add(new { id = "120", iconCls = "icon-add", pid = "m2", text = "商品辅助订货", url = "" });
            m2.Add(new { id = "121", iconCls = "icon-add", pid = "m2", text = "到货验收入库", url = "/Pc/PcPutinManageList" });
            m2.Add(new { id = "122", iconCls = "icon-add", pid = "m2", text = "采购批量入库", url = "/Pc/PcPutinManageList" });
