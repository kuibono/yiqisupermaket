...
<div class="ablock">
    ...
    <input type="text" class="mini-textbox" name="MsName" id="Control_MsName" vtype="maxLength:20" required="required" />
</div>

<div class="ablock">
    <label for="Control_Birthday">出生日期:</label>
    <input type="text" id="Control_Birthday" name="Birthday" class="mini-datepicker" format="yyyy-MM-dd" showtime="false" showokbutton="true" showclearbutton="true" required="false" />
</div>
