...
{
	///<summary>
	///表fb_supplier_archives的实体类(供货商档案)
	///</summary>
	public class FbSupplierArchives : EntityGUIDBase, IAggregateRootGUID
	{
		...
		/// 供货商类型
		/// </summary>
		[Validate(ValidateType.NoValidate,Name="供货商类型")]
		...
		/// 散件，整件
		/// </summary>
		[Validate(ValidateType.NoValidate,Name="散件，整件",DefaultValue="1")]
		...
		/// 扣率
		/// </summary>
		[Validate(ValidateType.IsDecimal ,Name="扣率",DefaultValue=0)]
		...
		/// 超额扣率
		/// </summary>
		[Validate(ValidateType.IsDecimal ,Name="超额扣率")]
        ...
        /// </summary>
        /// <returns></returns>
        public static FbSupplierArchives Initial()
        {
            FbSupplierArchives m = new FbSupplierArchives();
