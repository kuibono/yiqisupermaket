...
{
	///<summary>
	///表fb_adjust_saleprice的实体类(调商品售价)
	///</summary>
	public class FbAdjustSaleprice : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 调整日期
		/// </summary>
		...
		///实体复制
		public FbAdjustSaleprice Clone()
        {
            return (FbAdjustSaleprice)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static FbAdjustSaleprice Initial()
        {
