...
{
	///<summary>
	///表fb_adjust_purchaseprice的实体类(调商品进价)
	///</summary>
	public class FbAdjustPurchaseprice : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 调整日期
		/// </summary>
		...
		///实体复制
		public FbAdjustPurchaseprice Clone()
        {
            return (FbAdjustPurchaseprice)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static FbAdjustPurchaseprice Initial()
        {
