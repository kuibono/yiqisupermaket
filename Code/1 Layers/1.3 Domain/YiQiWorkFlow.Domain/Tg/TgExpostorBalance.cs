...
{
	///<summary>
	///表tg_expostor_balance的实体类(讲解员结算管理)
	///</summary>
	public class TgExpostorBalance : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 结算单号
		/// </summary>
		...
		/// 讲解员编码
		/// </summary>
		[Validate(ValidateType.NoValidate,Name="讲解员编码")]
		public virtual string ExpostorCode{get ; set; }
		
		/// <summary>
		/// 讲解员名称
		/// </summary>
		[Validate(ValidateType.NoValidate,Name="讲解员名称")]
		public virtual string ExpostorName{get ; set; }
		...
		///实体复制
		public TgExpostorBalance Clone()
        {
            return (TgExpostorBalance)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static TgExpostorBalance Initial()
        {
            TgExpostorBalance m = new TgExpostorBalance();
