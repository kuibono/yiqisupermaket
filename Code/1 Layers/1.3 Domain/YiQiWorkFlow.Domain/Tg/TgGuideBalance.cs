...
{
	///<summary>
	///表tg_guide_balance的实体类(导游结算管理)
	///</summary>
	public class TgGuideBalance : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 结算日期
		/// </summary>
		...
		/// 导游编码
		/// </summary>
		[Validate(ValidateType.NoValidate,Name="导游编码")]
		...
		///实体复制
		public TgGuideBalance Clone()
        {
            return (TgGuideBalance)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static TgGuideBalance Initial()
        {
            TgGuideBalance m = new TgGuideBalance();
