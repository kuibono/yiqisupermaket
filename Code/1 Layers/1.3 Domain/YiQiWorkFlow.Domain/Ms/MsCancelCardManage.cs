...
{
	///<summary>
	///表ms_cancel_card_manage的实体类(卡作废)
	///</summary>
	public class MsCancelCardManage : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 作废单号
		/// </summary>
		[Validate(ValidateType.IsEmpty ,Name="作废单号")]
		...
		/// 作废日期
		/// </summary>
		[Validate(ValidateType.IsDateTime ,Name="作废日期")]
		public virtual System.DateTime? CancelDate{get ; set; }
		
		/// <summary>
		/// 作废原因
		/// </summary>
		[Validate(ValidateType.NoValidate,Name="作废原因")]
		...
		///实体复制
		public MsCancelCardManage Clone()
        {
            return (MsCancelCardManage)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
