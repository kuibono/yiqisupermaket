...
{
	///<summary>
	///表ba_supplier_balance的实体类(供货商结算)
	///</summary>
	public class BaSupplierBalance : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 结算单号
		/// </summary>
		...
		///实体复制
		public BaSupplierBalance Clone()
        {
            return (BaSupplierBalance)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BaSupplierBalance Initial()
        {
            BaSupplierBalance m = new BaSupplierBalance();
