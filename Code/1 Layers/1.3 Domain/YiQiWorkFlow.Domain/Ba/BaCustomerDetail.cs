...
{
	///<summary>
	///表ba_customer_detail的实体类(客户结算明细)
	///</summary>
	public class BaCustomerDetail : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 结算单号
		/// </summary>
		...
		///实体复制
		public BaCustomerDetail Clone()
        {
            return (BaCustomerDetail)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BaCustomerDetail Initial()
        {
            BaCustomerDetail m = new BaCustomerDetail();
