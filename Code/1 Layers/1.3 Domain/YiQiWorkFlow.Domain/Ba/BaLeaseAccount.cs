...
namespace YiQiWorkFlow.Domain.Ba
{
	...
	public class BaLeaseAccount : EntityGUIDBase, IAggregateRootGUID
	{
		...
		///实体复制
		public BaLeaseAccount Clone()
        {
            return (BaLeaseAccount)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BaLeaseAccount Initial()
        {
            BaLeaseAccount m = new BaLeaseAccount();
