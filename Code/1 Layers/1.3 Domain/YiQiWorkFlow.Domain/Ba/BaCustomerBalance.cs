...
{
	///<summary>
	///表ba_customer_balance的实体类(客户结算)
	///</summary>
	public class BaCustomerBalance : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 结算日期
		/// </summary>
		...
		///实体复制
		public BaCustomerBalance Clone()
        {
            return (BaCustomerBalance)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BaCustomerBalance Initial()
        {
            BaCustomerBalance m = new BaCustomerBalance();
