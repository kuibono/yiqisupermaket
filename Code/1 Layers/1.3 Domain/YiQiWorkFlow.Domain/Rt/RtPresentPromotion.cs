...
{
	///<summary>
	///表rt_present_promotion的实体类(馈赠促销)
	///</summary>
	public class RtPresentPromotion : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 企业编码
		/// </summary>
		...
		///实体复制
		public RtPresentPromotion Clone()
        {
            return (RtPresentPromotion)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static RtPresentPromotion Initial()
        {
            RtPresentPromotion m = new RtPresentPromotion();
