...
{
	///<summary>
	///表rt_sheet_promotion_goods的实体类(整单促销_商品明细)
	///</summary>
	public class RtSheetPromotionGoods : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 促销单号
		/// </summary>
		...
		///实体复制
		public RtSheetPromotionGoods Clone()
        {
            return (RtSheetPromotionGoods)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static RtSheetPromotionGoods Initial()
        {
            RtSheetPromotionGoods m = new RtSheetPromotionGoods();
