...
{
	///<summary>
	///表bs_supply_promotion的实体类(配价促销)
	///</summary>
	public class BsSupplyPromotion : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 企业编码
		/// </summary>
		...
		///实体复制
		public BsSupplyPromotion Clone()
        {
            return (BsSupplyPromotion)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static BsSupplyPromotion Initial()
        {
            BsSupplyPromotion m = new BsSupplyPromotion();
