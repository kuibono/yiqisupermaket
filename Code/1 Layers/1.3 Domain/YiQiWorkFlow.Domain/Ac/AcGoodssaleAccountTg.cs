...
{
	///<summary>
	///表ac_goodssale_account_tg的实体类(商品销售帐表_tg)
	///</summary>
	public class AcGoodssaleAccountTg : EntityBase, IAggregateRoot
	{
		/// <summary>
		/// 企业编码
		/// </summary>
		...
		///实体复制
		public AcGoodssaleAccountTg Clone()
        {
            return (AcGoodssaleAccountTg)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static AcGoodssaleAccountTg Initial()
        {
            AcGoodssaleAccountTg m = new AcGoodssaleAccountTg();
			m.SalePrice=0M;
			m.PurchasePrice=0M;
