...
{
	///<summary>
	///表op_split_com_manage的实体类(组合拆零管理)
	///</summary>
	public class OpSplitComManage : EntityGUIDBase, IAggregateRootGUID
	{
		/// <summary>
		/// 处理单号
		/// </summary>
		...
		///实体复制
		public OpSplitComManage Clone()
        {
            return (OpSplitComManage)this.MemberwiseClone();
        }
		/// <summary>
        /// 初始化实体
        /// </summary>
        /// <returns></returns>
        public static OpSplitComManage Initial()
        {
            OpSplitComManage m = new OpSplitComManage();
