...
namespace YiQiWorkFlow.Domain.Basement
{
    ...
    public partial class tg_group_balance
    {
        ...
        public Nullable<decimal> ta_returns_money { get; set; }
        ...
        public Nullable<decimal> nopay_money { get; set; }
        public string rebalance_cause { get; set; }
