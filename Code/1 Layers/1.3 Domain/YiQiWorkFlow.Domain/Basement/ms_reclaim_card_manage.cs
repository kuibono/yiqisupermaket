...
namespace YiQiWorkFlow.Domain.Basement
{
    ...
    public partial class ms_reclaim_card_manage
    {
        public string reclaim_number { get; set; }
        public string en_code { get; set; }
        public Nullable<System.DateTime> reclaim_date { get; set; }
        public string reclaim_reason { get; set; }
